...
class EtkinMadde(models.Model):
    ...
    etkin_maddedvo_id = fields.Many2one('hospital.etkin_maddedvo', string="Etkin Madde")
    etkin_madde_kodu = fields.Char(string="Etkin Madde Kodu", related="etkin_maddedvo_id.etkin_madde_kodu")
