{
    ...
    'summary': 'Module for e-prescriptions',
    'sequence': '10',
    'description': """E-PRESCRIPTIONS Software""",
    'author': '0mustafa',
    'maintainer': '0mustafa',
    'website': 'oodane.com',
    ...
    'data': [
        ...
        'wizard/views/eprescription_view.xml',
        'wizard/views/eprescription_query_view.xml',
        'wizard/views/query_eprescription_list_view.xml',
        ...
        'services/views/save_eprescription_view.xml',
        ...
        'services/views/query_eprescription_view.xml',
        'services/views/query_eprescription_list_view.xml',
        'services/views/query_ereport_view.xml',
        'services/views/query_ereport_list_view.xml',
        'services/views/delete_eprescription_view.xml',
