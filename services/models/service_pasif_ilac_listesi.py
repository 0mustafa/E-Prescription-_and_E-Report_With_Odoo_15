...
#
#
# -*- Geri Ödeme Kapsamında Olmayan İlaç Listesi Servisi -*-
#
#
import datetime
...
class PasifIlacListesiSorgula(models.Model):
    _name = "service.pasif_ilac_listesi"
    _description = "Geri Ödeme Kapsamında Olmayan İlaç Listesi Servisi"
    ...
    def pasif_ilac_listesi_sorgula(self):
        ...
        with client.settings(strict=False):
            ilac_listesi = client.service.pasifIlacListesiSorgula(**vals)
