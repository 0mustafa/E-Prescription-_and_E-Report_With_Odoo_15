...
#
#
# -*- Turuncu Reçete ile Kaydedilebilen İlaç Listesi Servisi -*-
#
#
import datetime
...
class TuruncuReceteIlacListesiSorgula(models.Model):
    _name = "service.turuncu_ilac_listesi"
    _description = "turuncu Reçete İle Kaydedilebilen İlaç Listesi Servisi"
    ...
    def turuncu_ilac_listesi_sorgula(self):
        ...
        with client.settings(strict=False):
            ilac_listesi = client.service.turuncuReceteIlacListesiSorgula(**vals)
