...
#
#
# -*- E-Rapor Açıklama Ekleme Servisi -*-
#
#
...
class AddEreportExplanation(models.Model):
    _name = "hospital.service.add.ereport.explanation"
    ...
    explanation_lines = fields.One2many('hospital.ereport.explanation', 'service_exp_id',
    ...
    def add_explanation(self):
        ...
        if erapor.sonucKodu == '0000':
            ...
            ereport.rapor_aciklama_listesi = [(4, explanation.id) for explanation in self.explanation_lines]
