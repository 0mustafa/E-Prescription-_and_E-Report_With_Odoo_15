...
class AddEreportTeshis(models.Model):
    _name = "hospital.service.add.ereport.teshis"
    ...
    def add_teshis(self):
        ...
        if erapor.sonucKodu == '0000':
            ...
            ereport.rapor_teshis_listesi = [(0, 0, {
                'rapor_teshis_kodu': self.env['hospital.ereport.teshis']
...
class EreportAddTeshisLine(models.Model):
    ...
    service_add_ereport_teshis = fields.Many2one('hospital.service.add.ereport.teshis')
