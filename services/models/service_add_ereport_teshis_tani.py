...
#
#
# -*- E-Rapor Teşhise Tanı Ekleme Servisi -*-
#
#
...
class AddEreportTeshisTani(models.Model):
    ...
    def add_teshis_tani(self):
        ...
        teshis = self.env['ereport.teshis.line'].search([('id', '=', self.env.context['active_id'])])
        ereport_id = teshis.ereport_id
        ereport = self.env['hospital.ereport'].search([('id', '=', ereport_id)])
