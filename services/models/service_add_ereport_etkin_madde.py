...
#
#
# -*- E-Rapor Etkin Madde Ekleme Servisi -*-
#
#
...
class AddEreportExplanation(models.Model):
    _name = "hospital.service.add.ereport.etkinm"
    _description = "Hospital Add E-Report Etkin Madde Service"

    ereport_id = fields.Integer()
    doctor_id = fields.Many2one('hospital.doctor', string="Doktor")
    etkin_madde_lines = fields.Many2many('hospital.etkin_madde', string="Explanation Lines")
    ...
    def add_etkin_madde(self):
        ...
        if erapor.sonucKodu == '0000':
            ...
            ereport.rapor_etkin_madde_listesi = [(4, new_etkin_madde.id) for new_etkin_madde in self.etkin_madde_lines]
