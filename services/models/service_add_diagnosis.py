...
class AddDiagnosis(models.Model):
    ...
    _description = "Hospital Add Diagnosis Service"
    ...
    def add_diagnosis(self):
        ...
        eprescription = self.env['hospital.eprescription'].search([('id', '=', self.eprescription_id)])
        ...
        if erecete_tani_ekle.sonucKodu == '0000':
            ...
            active_model_id.diagnosis_line_ids = [(4, diagnosis.id) for diagnosis in self.add_diagnoises]
