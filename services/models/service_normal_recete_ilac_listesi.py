...
#
#
# -*- Normal Reçete ile Kaydedilebilen İlaç Listesi Servisi -*-
#
#
import datetime
...
class NormalReceteIlacListesiSorgula(models.Model):
    ...
    _description = "Normal Reçete İle Kaydedilebilen İlaç Listesi Servisi"
    ...
    def normal_ilac_listesi_sorgula(self):
        ...
        with client.settings(strict=False):
            ilac_listesi = client.service.normalReceteIlacListesiSorgula(**vals)
